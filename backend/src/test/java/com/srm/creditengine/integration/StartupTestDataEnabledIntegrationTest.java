...
class StartupTestDataEnabledIntegrationTest extends AbstractMySqlIntegrationTest {
    ...
    @Autowired
    private StartupTestDataService startupTestDataService;
    ...
    void shouldSeedVisibleStartupDatasetForLocalValidation() {
        ...
        BigDecimal latestBrlUsd = jdbcTemplate.queryForObject(
                """
                SELECT rate
                FROM exchange_rates
        ...
        Map<String, Object> statementShape = jdbcTemplate.queryForMap(
                """
                SELECT
