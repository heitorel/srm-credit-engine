...
class ExchangeRateValueTypesTest {
    ...
    void shouldUseBigDecimalForExchangeRateValueAcrossLayers() throws Exception {
        assertThat(CreateExchangeRateRequest.class.getRecordComponents()[2].getType()).isEqualTo(BigDecimal.class);
        assertThat(ExchangeRateResponse.class.getRecordComponents()[3].getType()).isEqualTo(BigDecimal.class);
        assertThat(Rate.class.getRecordComponents()[0].getType()).isEqualTo(BigDecimal.class);
        assertThat(ExchangeRateEntity.class.getDeclaredField("rate").getType()).isEqualTo(BigDecimal.class);
    }
}
