...
public class DuplicateSettlementException extends ConflictException {
  ...
  public DuplicateSettlementException(String externalReference, String assignorIdentifier) {
    super(
        "Receivable %s for assignor %s has already been settled."
            .formatted(externalReference, assignorIdentifier),
        List.of(
            new ApiErrorDetail(
                "receivables.externalReference", "This receivable has already been settled.")));
  }

  public DuplicateSettlementException(
      String externalReference, int itemIndex, String assignorIdentifier) {
    super(
        "Receivable %s for assignor %s has already been settled."
            .formatted(externalReference, assignorIdentifier),
        List.of(
  ...
  public DuplicateSettlementException() {
    super(
        ...
        List.of(
            new ApiErrorDetail("receivables", "One or more receivables were already settled.")));
  }
}
